...
export default function gameover(citySfx) {
  ...
  // loop through the rank values and compare the current score to the rank values to determine the current rank
  // if the current score is greater than the rank value, then the current rank is the rank grade at the current index
  // do the same for the best score to determine the best rank
  // maybe a better way to do this is to use a function to calculate the rank based on the score
